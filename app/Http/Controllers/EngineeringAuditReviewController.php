...
class EngineeringAuditReviewController extends JsonPayloadCrudController
{
    ...
    protected array $roleFieldMap = [
        'reviewed_by' => ['reviewedBy', 'reviewed_by', 'reviewerForAction', 'reviewer_for_action'],
        'responded_by' => ['respondedBy', 'responded_by'],
        'signed_by' => ['signedBy', 'signed_by'],
        'client_project_manager_signed_by' => ['clientProjectManagerSignedBy', 'client_project_manager_signed_by'],
    ...
    protected array $roleDateFieldMap = [
        ...
        'signed_by_date' => ['signedByDate', 'signed_by_date', 'reviewerFollowUpDate', 'reviewer_follow_up_date'],
        'client_project_manager_signed_by_date' => ['clientProjectManagerSignedByDate', 'client_project_manager_signed_by_date', 'tlReviewDate', 'tl_review_date'],
        'acknowledged_by_date' => ['acknowledgedByDate', 'acknowledged_by_date', 'diAcknowledgeDate', 'di_acknowledge_date'],
    ];
