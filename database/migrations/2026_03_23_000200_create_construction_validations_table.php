...
class CreateConstructionValidationsTable extends Migration
{
    public function up()
    {
        Schema::create('construction_validations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('construction_validations');
    }
}
