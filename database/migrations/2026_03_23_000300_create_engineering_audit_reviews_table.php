...
class CreateEngineeringAuditReviewsTable extends Migration
{
    public function up()
    {
        Schema::create('engineering_audit_reviews', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('engineering_audit_reviews');
    }
}
