...
class CreateSchematicDesignReviewsTable extends Migration
{
    public function up()
    {
        Schema::create('schematic_design_reviews', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('schematic_design_reviews');
    }
}
